...
This chapter explains the structure of the **Chart of Accounts** in Tally Prime, and gives step-by-step procedures to create **Primary Groups**, **Sub-Groups**, and **Ledgers** (single and bulk). Examples and a CSV import example are included.
...
⚠️ **Warning:** Deleting accounts with transactions can cause data issues.  
Use *Alter → Set to Inactive* where possible, or take a backup first.
